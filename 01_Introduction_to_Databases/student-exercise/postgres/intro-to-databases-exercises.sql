...
SELECT name
        ...
        , gnp
FROM country
WHERE gnp > 1000000;  -- have to revise
...
SELECT name
        ,region
FROM country
WHERE (continent = 'North America' AND region != 'Caribbean' OR continent = 'South America' AND region != 'Caribbean');
...
SELECT name
        , indepyear AS number_of_years_since_independence
FROM country
